...
urlpatterns = [
    ...
    path('delete_employee/<str:emp_id>/', views.delete_employee, name='delete_employee'),
    path('confirm_delete_employee/', views.confirm_delete_employee, name='confirm_delete_employee'),
]
