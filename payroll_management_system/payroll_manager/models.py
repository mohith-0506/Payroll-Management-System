...
class MPaygrade(models.Model):
    ...
    grade = models.ForeignKey('MGrade',on_delete=models.CASCADE)
    basic_amt = models.IntegerField(default=100000)
    da_amt = models.IntegerField(default=22000)
    pf_amt = models.IntegerField(default=12000)
    medical_amt = models.IntegerField(default=10000)
...
class MPay(models.Model):
    employee = models.ForeignKey(MEmployee,on_delete=models.CASCADE)
    fin_year = models.IntegerField(default=datetime.now().year)
    gross_salary = models.IntegerField(default=200000)
    gross_dedn = models.IntegerField(default=2000)
    net_salary = models.IntegerField(default=198000)
    MPay_id = models.AutoField(primary_key=True)
    achivement_reward = models.IntegerField(default=0)
    class Meta:
        managed = True
        db_table = 'm_pay'
